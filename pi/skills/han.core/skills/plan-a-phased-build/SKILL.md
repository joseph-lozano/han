...
Launch the `information-architect` agent in a single Agent tool call (pass `model: "openai-codex/gpt-5.5:low"`) to review the rendered `build-phase-outline.md` for findability, orientation, scannability, and progressive comprehension. Provide:
